...
class VideoListInfo extends Object with _$VideoListInfoSerializerMixin{
  VideoListInfo(this.count, this.total, this.refreshCount, this.nextPageUrl, this.itemList);
  int count;
  int total;
  int refreshCount;
  String nextPageUrl;
  List<VideoData> itemList;
  factory VideoListInfo.fromJson(Map<String, dynamic> json) => _$VideoListInfoFromJson(json);
}
...
@JsonSerializable()
class Video{
  Video(this.dataType, this.id, this.actionUrl, this.description
      , this.provider, this.category, this.author, this.cover, this.playUrl
      , this.duration, this.library, this.content,this.consumption, this.type, this.titlePgc
      , this.descriptionPgc, this.remark, this.idx, this.date, this.descriptionEditor
      , this.collected, this.played, this.playInfo, this.title, this.text);
  String dataType;
  int id;
  String actionUrl;
  String description;
...
class PlayInfo extends Object with _$PlayInfoSerializerMixin{
  PlayInfo(this.height, this.width, this.name, this.type, this.url, this.urlList);
  int height;
  int width;
  String name;
  String type;
...
class Author extends Object with _$AuthorSerializerMixin{
  Author(this.id, this.icon, this.name, this.description, this.link, this.latestReleaseTime,this.videoNum);
  int id;
  String icon;
  String name;
  String description;
